...
public class Spaceship {
    ...
    public Spaceship(PVector position, float front, ResolutionManager resolutionManager) {
        ...
        this.front = front;
        this.radiusX = resolutionManager.getResolvedOfWidth(500);
        this.radiusY = resolutionManager.getResolvedOfHeight(281);
        ...
        this.minZ = resolutionManager.getResolvedOfWidth(500);
